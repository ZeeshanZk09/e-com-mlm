...
type UsersResponse = Awaited<ReturnType<typeof import('@/actions/admin/users').getUsers>>;
    ...
    <div className='space-y-4'>
      <div className='flex flex-col md:flex-row gap-3 md:items-end'>
        ...
        <div className='w-full md:w-40'>
          ...
          <Select value={blocked} onValueChange={(value) => setBlocked(value as typeof blocked)}>
            <SelectTrigger>
              <SelectValue placeholder='All' />
            </SelectTrigger>
            <SelectContent>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 min-h-[60vh]'>
        {users.length > 0 ? (
          users.map((user) => (
            <Card
              key={user.id}
              className='p-4 space-y-2 max-sm:max-h-[45%] flex flex-col items-start justify-center'
            >
              <div className='w-full flex items-center gap-3'>
                <Avatar className='size-9'>
                  <AvatarFallback className='uppercase'>
                    {(user?.name as string | null)?.slice(0, 2) || user.email.slice(0, 2)}
                  </AvatarFallback>
                </Avatar>
                <div className='w-full'>
                  <div className='w-full flex items-center justify-between'>
                    ...
                    <UserRoleToggle
                      ...
                      disabled={
                        user.id === currentUserId || user.email === 'mzeeshankhan0988@gmail.com'
                      }
                    />
                    {user.isPlusMember && (
              ...
              <div className='w-full flex items-center justify-between text-xs mt-2'>
                ...
                <div className='flex flex-col items-end gap-1'>
                  ...
                  <div className='text-xs'>
                    <span
                      className={
                        user.isBlocked ? 'text-red-600 font-medium' : 'text-emerald-600 font-medium'
                      }
                    >
